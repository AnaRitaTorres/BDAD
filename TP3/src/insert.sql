...
/*1.ATUALIZA O DESCONTO NOS CLIENTES COM NECESSIDADES ESPECIAIS */
...
/*2.GARANTE QUE O SALÁRIO MINIMO REQUERIDO PELA EMPRESA SEJA APLICADO AOS FUNCIONARIOS*/
CREATE TRIGGER IF NOT EXISTS Salarios 
AFTER INSERT ON FUNCIONARIO
	BEGIN
		UPDATE FUNCIONARIO SET salario = 500 WHERE salario < 500;
	END; 
	
/*3.garante que existe pelo menos um mecanico a ser disponibilizado pela empresa caso nenhum exista*/	
...
INSERT INTO ITINERARIOESTACAO (ordem,idEstacao,idItinerario) VALUES (12,10,2);
INSERT INTO ITINERARIOESTACAO (ordem,idEstacao,idItinerario) VALUES (13,8,3);
INSERT INTO ITINERARIOESTACAO (ordem,idEstacao,idItinerario) VALUES (14,6,4);
INSERT INTO ITINERARIOESTACAO (ordem,idEstacao,idItinerario) VALUES (15,7,7);
INSERT INTO ITINERARIOESTACAO (ordem,idEstacao,idItinerario) VALUES (16,5,5);
INSERT INTO ITINERARIOESTACAO (ordem,idEstacao,idItinerario) VALUES (15,2,6);
INSERT INTO ITINERARIOESTACAO (ordem,idEstacao,idItinerario) VALUES (1,3,10);
...
INSERT INTO FUNCIONARIO(anoEntrada,salario,idFuncionario,idTipoDeFuncao) VALUES(2001,200,15,3);
INSERT INTO FUNCIONARIO(anoEntrada,salario,idFuncionario,idTipoDeFuncao) VALUES(2005,670,16,4);
INSERT INTO FUNCIONARIO(anoEntrada,salario,idFuncionario,idTipoDeFuncao) VALUES(2007,900,1,1);
...
INSERT INTO FUNCIONARIO(anoEntrada,salario,idFuncionario,idTipoDeFuncao) VALUES(1989,1000,5,1);
INSERT INTO FUNCIONARIO(anoEntrada,salario,idFuncionario,idTipoDeFuncao) VALUES(2013,713,22,2);
INSERT INTO FUNCIONARIO(anoEntrada,salario,idFuncionario,idTipoDeFuncao) VALUES(2016,500,23,11);
INSERT INTO FUNCIONARIO(anoEntrada,salario,idFuncionario,idTipoDeFuncao) VALUES(2011,700,24,4);
